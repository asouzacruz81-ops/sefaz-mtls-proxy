...
app.get("/version", (req, res) => res.json({ ok: true, version: "2.3.0-soap11-recepcaoNF", manifestacaoHost: "www.nfe.fazenda.gov.br", soapAction: "nfeRecepcaoEventoNF", soapVersion: "1.1", deployTime: new Date().toISOString() }));
